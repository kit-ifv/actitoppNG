...
val firstActivityUsesStandardDuration: ParametrizedDiscreteChoiceModel<Boolean, BooleanDecisionSituation, ParameterCollectionStep8A> = ModifiableDiscreteChoiceModel<Boolean, BooleanDecisionSituation, ParameterCollectionStep8A>(
